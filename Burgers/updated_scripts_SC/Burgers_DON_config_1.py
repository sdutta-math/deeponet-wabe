...
model_dir = "/work/08372/scai/ls6/deeponet-wabe-main/model/DON_config"
...
if case == 'Predict':
    ...
    model_path = model_dir+'_burgers1d_don'+timestamp_don+model_suffix
...
nn = don.don_nn(branch_input_shape = branch_sensors,
                ...
                t_neurons_layer =sett.neurons_layer, 
                t_actf =sett.t_actf, 
...
out_dir = os.path.join(model_dir, 'burgers1d_don'+timestamp_don+model_suffix) 
