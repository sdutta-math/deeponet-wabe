...
model_dir = "/work/08372/scai/ls6/deeponet-wabe-main/model/LDON_Config"
...
plt.savefig("Training_Validation Losses.png")
...
f3 = axs[2].imshow(pred_field.T - true_field.T,cmap='jet',origin='lower',vmin=valmin, vmax=valmax, extent=(0,T_train,0,L_train), 
                   aspect = 0.59)
...
plt.savefig("LDON_Prdiction_error.png")
